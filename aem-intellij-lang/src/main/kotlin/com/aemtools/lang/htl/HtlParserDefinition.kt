...
class HtlParserDefinition : ParserDefinition {
    ...
    override fun createLexer(project: Project?): Lexer = HtlLexer()

    override fun createParser(project: Project?): PsiParser = HtlParser()

    override fun createFile(viewProvider: FileViewProvider): PsiFile = HtlPsiFile(viewProvider)

    override fun spaceExistenceTypeBetweenTokens(left: ASTNode?, right: ASTNode?): ParserDefinition.SpaceRequirements = ParserDefinition.SpaceRequirements.MUST
    ...
    override fun getFileNodeType(): IFileElementType = HtlFileElementType
