...
class JpColorsAndFontsPage : ColorSettingsPage {
  ...
  override fun getDemoText(): String = buildString {
    ...
    appendLine(
      "<JP_BRACKETS>[</JP_BRACKETS><JP_VALUE>array.value1</JP_VALUE><JP_DELIMITER>,</JP_DELIMITER><JP_VALUE>array.value1</JP_VALUE><JP_BRACKETS>]</JP_BRACKETS>"
    )
    appendLine(
      "<JP_BRACES>{</JP_BRACES><JP_TYPE>Boolean</JP_TYPE><JP_BRACES>}</JP_BRACES><JP_VALUE>true</JP_VALUE>"
    )
    appendLine("<JP_VALUE>simple string value</JP_VALUE>")
    appendLine(
      """<JP_VALUE>It<JP_VALID_STRING_ESCAPE>\'</JP_VALID_STRING_ESCAPE>s a simple string value</JP_VALUE>"""
    )
    appendLine(
      """<JP_VALUE>Configure <JP_VALID_STRING_ESCAPE>&amp;</JP_VALID_STRING_ESCAPE> apply color settings</JP_VALUE>"""
    )
    appendLine(
      """<JP_VALUE>This is invalid - <JP_INVALID_STRING_ESCAPE>\u111</JP_INVALID_STRING_ESCAPE></JP_VALUE>"""
    )
  }
