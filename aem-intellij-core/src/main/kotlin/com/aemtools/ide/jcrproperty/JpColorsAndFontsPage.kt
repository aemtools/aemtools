...
class JpColorsAndFontsPage : ColorSettingsPage {
  ...
  override fun getDemoText(): String = buildString {
    append("<jcr:root jcr:primaryType=\"cq:Component\"\n")
    append("cq:isContainer\"<JP_BRACES>{</JP_BRACES><JP_TYPE>Boolean</JP_TYPE><JP_BRACES>}</JP_BRACES><JP_VALUE>true</JP_VALUE>\"\n")
    append("categories\"<JP_BRACKETS>[</JP_BRACKETS><JP_VALUE>app.cat1</JP_VALUE><JP_DELIMITER>,</JP_DELIMITER><JP_VALUE>app.cat2</JP_VALUE><JP_BRACKETS>]</JP_BRACKETS>\"\n")
    append("/>")
  }
