...
/**
 * Tests for HTL attributes documentation for HTL v 1.3.
 *
 * @author Kostiantyn Diachenko
 */
class HtlAttributesDocumentationProviderV13Test : HtlAttributesDocumentationProviderTest() {
  ...
  fun testDataSlyUseDocumentation() = docCase {
    ...
    documentation("""
            ...
            <b>Attribute identifier:</b><br>
             - required: false<br>
             - description: Customised identifier name to access the instantiated logic<br><br><br>See also: <a href="https://github.com/adobe/htl-spec/blob/1.3.1/SPECIFICATION.md#221-use">Htl Specification</a>
        """)
  }
  ...
  fun testDataSlyTestDocumentation() = docCase {
    ...
    documentation("""
            ...
            See also: <a href="https://github.com/adobe/htl-spec/blob/1.3.1/SPECIFICATION.md#225-test">Htl Specification</a>
        """)
  }
  ...
  fun testDataSlyRepeatDocumentation() = docCase {
    ...
    documentation("""
            ...
            See also: <a href="https://github.com/adobe/htl-spec/blob/1.3.1/SPECIFICATION.md#227-repeat">Htl Specification</a>
        """)
  }
  ...
  fun testDataSlyListDocumentation() = docCase {
    ...
    documentation("""
            ...
            <b>Attribute identifier:</b><br>
             - required: false<br>
             - description: Customised identifier name to access the item within the list element.<br><br><br>
            See also: <a href="https://github.com/adobe/htl-spec/blob/1.3.1/SPECIFICATION.md#226-list">Htl Specification</a>
        """)
  }
  ...
  fun testDataSlyTemplateDocumentation() = docCase {
    ...
    documentation("""
            ...
            See also: <a href="https://github.com/adobe/htl-spec/blob/1.3.1/SPECIFICATION.md#22101-template">Htl Specification</a>
        """)
  }
  ...
  fun testDataSlyAttributeDocumentation() = docCase {
    ...
    documentation("""
            ...
            See also: <a href="https://github.com/adobe/htl-spec/blob/1.3.1/SPECIFICATION.md#223-attribute">Htl Specification</a>
        """)
  }
  ...
  fun testDataSlyElementDocumentation() = docCase {
    ...
    documentation("""
            ...
            See also: <a href="https://github.com/adobe/htl-spec/blob/1.3.1/SPECIFICATION.md#224-element">Htl Specification</a>
        """)
  }
  ...
  fun testDataSlyCallDocumentation() = docCase {
    ...
    documentation("""
            ...
            See also: <a href="https://github.com/adobe/htl-spec/blob/1.3.1/SPECIFICATION.md#22102-call">Htl Specification</a>
        """)
  }
  ...
  fun testDataSlyIncludeDocumentation() = docCase {
    ...
    documentation("""
            ...
            See also: <a href="https://github.com/adobe/htl-spec/blob/1.3.1/SPECIFICATION.md#228-include">Htl Specification</a>
        """)
  }
  ...
  fun testDataSlyUnwrapDocumentation() = docCase {
    ...
    documentation("""
            ...
            See also: <a href="https://github.com/adobe/htl-spec/blob/1.3.1/SPECIFICATION.md#2211-unwrap">Htl Specification</a>
        """)
  }
  ...
  fun testDataSlyTextDocumentation() = docCase {
    ...
    documentation("""
            ...
            See also: <a href="https://github.com/adobe/htl-spec/blob/1.3.1/SPECIFICATION.md#222-text">Htl Specification</a>
        """)
  }
  ...
  fun testDataSlyResourceDocumentation() = docCase {
    ...
    documentation("""
            ...
            <b>Options:</b><br>
             - <strong>resourceType</strong>: forces the type of the rendered resource<br><br><br>
            See also: <a href="https://github.com/adobe/htl-spec/blob/1.3.1/SPECIFICATION.md#229-resource">Htl Specification</a>
        """)
  }
}
